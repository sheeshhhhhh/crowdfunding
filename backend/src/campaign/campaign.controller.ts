...
export class CampaignController {
    ...
    async createCampaign(@User() user: RequestUser, @Body() body: CreateCampaignDto, 
    ...
    async updateCampaign(@User() user: RequestUser, @Param('id') campaignId: string, @Body() body: UpdateCampaignDto
    , @UploadedFile() file: Express.Multer.File) {
        return this.campaignService.updateCampaign(campaignId, body, file, user);
    }

    @Delete(':id')
    async deleteCampaign(@User() user: RequestUser, @Param('id') campaignId: string) {
