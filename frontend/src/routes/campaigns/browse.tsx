              ...
              <PopoverContent className='w-80'>
                <div className="grid gap-4">
                    <div className="space-y-2">
                        ...
                        {['MEDICAL', 'EDUCATION', 'ENVIRONMENT', 'ANIMALS', 'DISASTER', 'BUSINESS', 'OTHER'].map((category) => (
                          <div key={category} className="flex items-center space-x-2">
                              ...
                              />
                              <Label className='first-letter:uppercase' htmlFor={category}>{category.toLowerCase()}</Label>
                          </div>
                        ))}
                    </div>
                    {/* <div className="space-y-2">
                    ...
                    <Button onClick={() => setFilter('')} variant="outline" className="w-full">
              ...
              <Card key={campaign.id} className="flex flex-col ">
                ...
                <CardHeader>
                  <div className="flex justify-between items-start">
                    ...
                    {campaign.category && <Badge className='mt-1'>{campaign.category}</Badge>}
                  </div>
                </CardHeader>
